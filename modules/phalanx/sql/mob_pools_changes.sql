...
UPDATE `mob_pools` SET `spellList` = 314 WHERE `poolid` IN (5898, 5905, 5910, 5972); -- Paladins
UPDATE `mob_pools` SET `spellList` = 316 WHERE `poolid` IN (5904, 5896, 5961, 5986, 6019); -- Black Mages
...
UPDATE `mob_pools` SET `cmbDelay` = 360 WHERE `poolid` IN (5901, 5930); -- Give Nanna-Mihgo (Thief Trust) dual wield