...
entity.onEventFinish = function(player, csid, option, npc)
    ...
    elseif csid == 510 and option == 0 then
        local stockA =
        {
            ...
            { xi.item.SCROLL_OF_CURE_II,    676, 3, },
            ...
            { xi.item.SCROLL_OF_BANISH,     162, 3, },
            { xi.item.SCROLL_OF_DIAGA,     1346, 3, },
            { xi.item.SCROLL_OF_BANISHGA,  1346, 3, },
            { xi.item.SCROLL_OF_PROTECT,    253, 3, },
            { xi.item.SCROLL_OF_SHELL,     1830, 3, },
            { xi.item.SCROLL_OF_BLINK,     2423, 3, },
            { xi.item.SCROLL_OF_STONESKIN, 8118, 3, },
    ...
    elseif csid == 510 and option == 1 then
        local stockB =
        {
            ...
            { xi.item.SCROLL_OF_POISON,     95, 3, },
            { xi.item.SCROLL_OF_BIO,       416, 3, },
            { xi.item.SCROLL_OF_BLIND,     128, 3, },
            { xi.item.SCROLL_OF_SLEEP,    2600, 3, },
