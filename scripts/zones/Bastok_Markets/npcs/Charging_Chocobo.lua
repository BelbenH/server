...
entity.onTrigger = function(player, npc)
    local stock =
    {
        ...
        { xi.item.BRASS_CUISSES,    16228, 3 },
        { xi.item.CUISSES,          39690, 3 },
        { xi.item.MYTHRIL_CUISSES,  66399, 3 },
        { xi.item.BRONZE_LEGGINGS,    134, 3 },
        { xi.item.SCALE_GREAVES,     1139, 3 },
        { xi.item.BRASS_GREAVES,     9609, 3 },
        { xi.item.PLATE_LEGGINGS,   24948, 3 },
        { xi.item.MYTHRIL_LEGGINGS, 41527, 3 },
        { xi.item.GORGET,           19278, 3 },
        { xi.item.LEATHER_BELT,       446, 3 },
        { xi.item.SILVER_BELT,      11995, 3 },
        { xi.item.SWORDBELT,        22651, 3 },
    }

    player:showText(npc, zones[xi.zone.BASTOK_MARKETS].text.CHARGINGCHOCOBO_SHOP_DIALOG)
    xi.shop.general(player, xi.shop.phalanxShops.lowTierMisc, xi.fameArea.BASTOK)
end
