...
entity.onTrigger = function(player, npc)
    local stock =
    {
        ...
        { xi.item.SCROLL_OF_CURE_II,     682, 3 },
        ...
        { xi.item.SCROLL_OF_BANISH,      163, 3 },
        { xi.item.SCROLL_OF_DIAGA,      1359, 3 },
        { xi.item.SCROLL_OF_BANISHGA,   1359, 3 },
        { xi.item.SCROLL_OF_PROTECT,     256, 3 },
        { xi.item.SCROLL_OF_SHELL,      1848, 3 },
        { xi.item.SCROLL_OF_BLINK,      2446, 3 },
    ...
    xi.shop.general(player, xi.shop.phalanxShops.lowTierWhiteMagic, xi.fameArea.BASTOK)
end
