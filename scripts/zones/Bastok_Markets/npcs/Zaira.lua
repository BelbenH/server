...
entity.onTrigger = function(player, npc)
    local stock =
    {
        ...
        { xi.item.SCROLL_OF_POISON,     96, 3 },
        { xi.item.SCROLL_OF_BIO,       420, 3 },
        { xi.item.SCROLL_OF_BLIND,     128, 3 },
        { xi.item.SCROLL_OF_SLEEP,    2625, 3 },
    ...
    xi.shop.general(player, xi.shop.phalanxShops.lowTierBlackMagic, xi.fameArea.BASTOK)
end
