...
zones[xi.zone.BHAFLAU_THICKETS] =
{
    text =
    {
        ...
        STAGING_GATE_MAMOOL           = 7328, -- Mamool Ja Staging Point.
        ...
        HAND_OVER_TO_IMMORTAL         = 7558, -- You hand over the % to the Immortal.
        YOUR_IMPERIAL_STANDING        = 7559, -- Your Imperial Standing has increased!
        HARVESTING_IS_POSSIBLE_HERE   = 7577, -- Harvesting is possible here if you have <item>.
        CANNOT_ENTER                  = 7600, -- You cannot enter at this time. Please wait a while before trying again.
        AREA_FULL                     = 7601, -- This area is fully occupied. You were unable to enter.
        MEMBER_NO_REQS                = 7605, -- Not all of your party members meet the requirements for this objective. Unable to enter area.
        MEMBER_TOO_FAR                = 7609, -- One or more party members are too far away from the entrance. Unable to enter area.
        WELLSPRING                    = 7669, -- The water in this spring is an unusual color...
        SHED_LEAVES                   = 7678, -- The ground is strewn with shed leaves...
        BLOOD_STAINS                  = 7680, -- The ground is smeared with bloodstains...
        DRAWS_NEAR                    = 7705, -- Something draws near!
