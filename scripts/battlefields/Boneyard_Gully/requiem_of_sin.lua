...
{
    {
        ...
        { itemId = xi.item.PIECE_OF_CASSIA_LUMBER,   weight = 250 },
        { itemId = xi.item.DRAGON_BONE,              weight = 250 },
        { itemId = xi.item.SQUARE_OF_ELTORO_LEATHER, weight = 250 },
        { itemId = xi.item.SQUARE_OF_GALATEIA,       weight = 250 },
        { itemId = xi.item.SQUARE_OF_KEJUSU_SATIN,   weight = 250 },
    },
    {
        { itemId = xi.item.NONE,                     weight = 750 },
        { itemId = xi.item.XS_KNIFE,                 weight =  50 },
        { itemId = xi.item.YS_SCYTHE,                weight =  50 },
        { itemId = xi.item.ZS_TRIDENT,               weight =  50 },
        { itemId = xi.item.LACQUER_TREE_LOG,         weight =   5 },
        { itemId = xi.item.PHOENIX_FEATHER,          weight =   5 },
        { itemId = xi.item.PHILOSOPHERS_STONE,       weight =   5 },
    },
    {
        { itemId = xi.item.NONE,                     weight =  750 },
