...
xi.settings.main =
{
    ...
    EXP_RATE            = 0.800, -- Multiplies exp from script (except FoV/GoV).
    ...
    INACTIVITY_WATCHDOG_PERIOD  = 20000,  -- Time in milliseconds which the inactivity watchdog will wait between ticks of the main loop before potentially killing the target process.

    -- PHALANX
    ALPHA_MOB_SPAWN_CHANCE   = 5, -- Scale between 0-100
    AUGMENT_CASKET_DROP_RATE = 2,  -- Multiplier. Ex. 2 = twice as likely to appear
